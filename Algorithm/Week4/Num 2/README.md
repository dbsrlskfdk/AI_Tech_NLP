...
<p>첫째 줄에 노드의 개수 <em>N</em>(2 &le; <em>N</em> &le; 200,000), 질문의 횟수 <em>M</em>(1 &le;<em> M</em> &le; 200,000), <em>N</em>번 노드가 가리키는 노드의 번호 <em>V</em>(2 &le; <em>V</em> &le; <em>N</em>)가 공백으로 구분되어&nbsp;주어진다.</p>

<p>둘째 줄에 <em>N</em>개의 정수 <em>C<sub>1</sub>, C<sub>2</sub>, &hellip;, C<sub>N</sub></em>이 공백으로 구분되어 주어진다. 이때 <em>C<sub>i</sub></em>는 <em>i</em>번 노드에 저장된 값을 뜻한다. (1 &le; <em>C<sub>i</sub></em> &le; 1,000,000)</p>

<p>셋째 줄부터 <em>M</em>개의 줄에 걸쳐 각 질문에 해당하는 <em>K</em>(1 &le; <em>K</em> &le; 10<sup>9</sup>)가 주어진다.</p>
